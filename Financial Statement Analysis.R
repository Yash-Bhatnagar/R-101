...
Is_good_month <- profit_after_tax > mean(profit_after_tax)
Is_Bad_month <- profit_after_tax < mean(profit_after_tax)

Is_BEST_Month <- profit_after_tax == max(profit_after_tax)
Is_WORST_Month <- profit_after_tax == min(profit_after_tax)

#Unit correction 
Profit_1k <- round(profit/1000)
Profit_After_Tax_1k <- round(profit_after_tax/1000)
Revenue_1k <- round(revenue/1000)
Expenses_1k <- round(expenses/1000)

#Result in data frame format
Result_df <- data.frame(Revenue_1k,Expenses_1k,
                        Profit_1k,
                        Profit_After_Tax_1k,
                        profit_margin,
                        Is_good_month,
...
Result_mx <- rbind(Revenue_1k,Expenses_1k,
                   Profit_1k,
                   Profit_After_Tax_1k,
                   profit_margin,
                   Is_good_month,
...
#To view the matrix in console
Result_mx

#To view the matrix in another tab
View(Result_mx)

#To view the df in console
Result_df

#To view the df in another tab
View(Result_df)